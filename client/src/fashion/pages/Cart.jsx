    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.container_top}>
                ...
                <div className={styles.container_top__texts}>
                    <span className={styles.container_top__text}>Shopping Bag (2)</span>
                    <span className={styles.container_top__text}>Your Wishlist</span>
                </div>
