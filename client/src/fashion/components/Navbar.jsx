            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.right}>
                    <div className={styles.menu_item}>
                        <Link style={{ textDecoration: "none", color: "inherit" }} to='/fashion/cart'>
                    ...
                    {isAuthenticated ? (
                        ...
                        <>
                            <Link to='/fashion/signup' className={styles.menu_auth}>REGISTER</Link>
                            <Link to='/fashion/signin' className={styles.menu_auth}>SIGN IN</Link>
                        </>
                    )}
                </div>
            </div>
